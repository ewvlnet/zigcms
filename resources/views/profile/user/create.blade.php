<x-profile-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <header class="col-md-6 px-0"><h4 class="fw-bold py-3"><span
                    class="text-muted fw-light">Create /</span> User</h4>
        </header>
        <x-shared.flash-msg/>
                ...
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <p class="px-4"><small class="text-danger">*Inform the password</small></p>
                                <hr class="mb-4">
                            </div>

                            <form action="{{ route('profile.users.store') }}" class="form" id="formData" method="POST">
                                @csrf
                                <div class="row px-3">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <x-shared.form.input label="{{__('Password')}}" name="password" type="password"
                                                             placeholder="{{__('Password user')}}" required="on"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
