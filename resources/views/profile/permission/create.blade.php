<x-profile-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <header class="col-md-6 px-0"><h4 class="fw-bold py-3"><span
                    class="text-muted fw-light">Create /</span> Permission</h4>
        </header>
        <x-shared.flash-msg/>
                ...
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="card-body">
                            ...
                            <form action="{{ route('profile.permissions.store') }}" class="form" id="formData" method="POST">
                                @csrf
                                <div class="row px-3">
                                ...
                                <x-shared.form.input label="{{__('Name')}}" name="name" value="{{ old('name') }}"
                                    ...
                                    <div class="mb-3 col-md-6">
                                          <x-shared.form.textarea label="{{__('Permission description')}}" name="description" value="{{ old('description') }}"
                                                rows="5" placeholder="{{__('Permission short description')}}"/>
                                    </div>
                                </div>
