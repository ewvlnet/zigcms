<x-profile-layout>
    <x-slot name="title">{{ __('Create Profile') }}</x-slot>

    <div class="container-xxl flex-grow-1 container-p-y">
        <header class="col-md-6 px-0"><h4 class="fw-bold py-3"><span
                    class="text-muted fw-light">Create /</span> Profile</h4>
        </header>
        <x-shared.flash-msg/>
                ...
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="card-body">
                            ...
                            <form action="{{ route('profile.profiles.store') }}" class="form" id="formData"
                                  method="POST">
                                @csrf
                                <div class="row px-3">
